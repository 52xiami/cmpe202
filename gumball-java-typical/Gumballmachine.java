  ...
  class GumballMachine {
    //initiate instance variables
     ...
     void get_GumballMachine_information(){
         System.out.println("GumballMachine Information:");
         System.out.println("The price of per Gumball is: " + this.price_per_gumball + " cents");
         System.out.print("The acceptable coins are: ");
...
class Demo {
    public static void main(String[] args) {
        //Create a GumballMachine model
        GumballMachine m1 = new GumballMachine(10, 25, Coins_kind.quarter);
        m1.get_GumballMachine_information();
        m1.insertQuarter(25);
        m1.turnCrank();
